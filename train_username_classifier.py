...
from username_classifier import _features_from_crop, train, save_model, FEATURE_NAMES

DATA_DIR = Path(__file__).resolve().parent / "training_data" / "username_classifier"
